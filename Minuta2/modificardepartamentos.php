...
<html lang="en">
  ...
  <body>
	...
	<br>
	<h1>Modificar Departamentos</h1> <br>
	
	<?php
    
	//$id_departamento = $_POST['id_departamento'];
	$id_departamento = $_GET['id_departamento'];
    $consulta1 = "SELECT id_departamento,nombre, detalle FROM departamento where id_departamento='$id_departamento'";
    //echo $consulta1;
    $columna1 = mysqli_query($conexion, $consulta1 ) or die ( "Error en consulta base de datos");
	// Bucle while que recorre cada registro y muestra cada campo en la tabla.
	echo "<form name='f1' id='f1' method='post' action ='modificardepartamentos2.php' >";
	while ($filas = mysqli_fetch_array( $columna1))
	{
    echo "<br>";
		echo " id Departamento " ;
		echo "<input name ='id' type ='text' readonly value='".$filas["id_departamento"]."'>";
		echo "<br>";
		echo "<br>";
