...
<html lang="en">
  ...
  <body>
	...
	<?php
		$consulta1 = "SELECT * FROM seguimiento";		
	    ...
	    while($filas = mysqli_fetch_array($columna1))
	      {
			...
			echo "<td>"."<a href='modificarseguimientos.php?id_seguimiento=".$filas['id_seguimiento']."' class='btn btn-success'><i class='fas fa-edit'></i>  Editar</a>". "</td>";
			echo "<td> "."<a href='eliminarseguimientos.php?id_seguimiento=".$filas['id_seguimiento']."' class='btn btn-danger'><i class='far fa-trash-alt'></i>  Eliminar</a>". "</td>";
			echo "</tr>";
		  }	
	...
	<br>
	<div class="bAgregar">
			<a class="btn btn-outline-info" href="agregarseguimientos.php">Agregar seguimientos</a>
