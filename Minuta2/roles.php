...
<html lang="en">
  ...
  <body>
	    ...
	    while($filas = mysqli_fetch_array($columna1))
	      {
			...
			echo "<td>"."<a href='modificarroles.php?id_rol=".$filas['id_rol']."' class='btn btn-success'><i class='fas fa-edit'></i>  Editar</a>". "</td>";
			echo "<td> "."<a href='eliminarroles.php?id_rol=".$filas['id_rol']."' class='btn btn-danger'><i class='far fa-trash-alt'></i>  Eliminar</a>". "</td>";
			echo "</tr>";
		  }	
	...
	<br>
	<div class="bAgregar">
			<a class="btn btn-outline-info" href="agregarroles.php">Agregar Roles</a>
