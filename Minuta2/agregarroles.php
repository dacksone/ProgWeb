...
<html lang="en">
  ...
  <body>
	...
	<br>
	<h1>Agregar roles</h1> <br>
	<form name="f1" id="f1" method="post" action="grabarroles.php">
		<br>
		Nombre del rol: <input type="text" name="nombrederol" id="nombrederol">
		<br>
		Detalle: <input type="text" name="detallerol" id="detallerol">
		<br>
